   ...
   $('#render_graph').click(function() {
      ...
      switch (data_select) {
         case 'all_events_small_network':
            data_uri = 'https://github.com/jjmpalma/jjmpalma.github.io/tree/main/visualecommerce/data_json/all_events_small_network.json';
            break;
         
         case 'all_events_big_network':
            data_uri = 'https://github.com/jjmpalma/jjmpalma.github.io/tree/main/visualecommerce/data_json/all_events_big_network.json';
            break;
         
         case 'purchase_events_small_network':
            data_uri = 'https://github.com/jjmpalma/jjmpalma.github.io/tree/main/visualecommerce/data_json/purchase_events_small_network.json';
            break;

         case 'purchase_events_big_network':
            data_uri = 'https://github.com/jjmpalma/jjmpalma.github.io/tree/main/visualecommerce/data_json/purchase_events_big_network.json';
            break;

         case 'cart_events_small_network':
            data_uri = 'https://github.com/jjmpalma/jjmpalma.github.io/tree/main/visualecommerce/data_json/cart_events_small_network.json';
            break;

         case 'cart_events_big_network':
            data_uri = 'https://github.com/jjmpalma/jjmpalma.github.io/tree/main/visualecommerce/data_json/cart_events_big_network.json';
            break;

         case 'view_events_small_network':
            data_uri = 'https://github.com/jjmpalma/jjmpalma.github.io/tree/main/visualecommerce/data_json/view_events_small_network.json';
            break;
         
         case 'view_events_big_network':
            data_uri = 'https://github.com/jjmpalma/jjmpalma.github.io/tree/main/visualecommerce/data_json/view_events_big_network.json';
            break;
      }
